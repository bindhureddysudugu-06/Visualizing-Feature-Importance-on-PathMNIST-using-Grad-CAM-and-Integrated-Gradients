...
def apply_mask_to_image(input_tensor, binary_mask):
    ...
    masked_image = input_tensor.clone() * (1.0 - mask_tensor) + mean_val * mask_tensor
    return masked_image

# experimental setup
num_samples_to_test = 20
top_fraction = 0.05   # top 5% important pixels
sample_idx = 0
...
for images, labels in test_loader:
    ...
    # evaluation of masked confidence for same original predicted class
    with torch.no_grad():
